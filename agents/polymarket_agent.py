...
REPLACEMENTS = [
    ...
    (r"will the fed (hold|pause|keep) (interest )?rates?.*", "Оставит ли ФРС ставку без изменений?"),
    ...
    (r"will there be a nuclear (attack|strike|detonation).*", r"Будет ли ядерный удар?"),
